...
struct MovieCollectionView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> UICollectionView {
        ...
        //set datasource and delegate to coordinator because they conform to the 2 protocols
    ...
    class Coordinator: NSObject, UICollectionViewDataSource, UICollectionViewDelegate {
        ...
        //Returns number of sections (4)
        func numberOfSections(in collectionView: UICollectionView) -> Int {
            return parent.allItems.count
        }
        
        //returns number of items in section (Movie or Actors)
        func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
            return parent.allItems[HomeSection.allCases[section]]?.count ?? 0
        }
        
        //Creates header for each section and wire onSeeAllClicked closure from HeaderView
        ...
        //for each section it will deque and return the corresponding cell
        ...
        func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
            return parent.didSelectItem(indexPath)
        }
